-- ============================================================
-- Volcado de datos (INSERT) — Proyecto AR_leyendas-bacalar
-- Esquema: public | Supabase project: wkkzgyhyarqwxoqcdaul
-- Snapshot generado en modo lectura (2026-07-14)
-- Orden pensado para respetar dependencias de llaves foráneas.
-- Tablas vacías (sin INSERT): creator_onboarding_email_tokens,
--   favorites, mobile_devices, physical_edition_markers,
--   reading_progress, reviews, scan_logs
-- ============================================================
